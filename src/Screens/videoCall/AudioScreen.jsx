...
//         onJoinChannelSuccess: () => setConnectionStatus('Connected'),
//         onUserJoined: (_, Uid) => setPeerIds(prev => [...prev, Uid]),
//         onUserOffline: (_, Uid) => setPeerIds(prev => prev.filter(id => id !== Uid)),
//         onError: () => setConnectionStatus('Not Connected'),
//       });
//     }
...
//     try {
//       const filePath = `${RNFS.DocumentDirectoryPath}/call_recording_${Date.now()}.aac`;
...
//     webSocket.on('VideoCallAnswered', async () => {
//       await engine.current?.leaveChannel();
//       navigation.navigate('VideoCall', { config, mobile, userInfo, chatId });
//     });
...
//     };
//   }, [webSocket, engine, navigation, config, mobile, userInfo, chatId, activeCall, startCall]);
...
//               <SvgXml xml={SVG_arrow_back} width={30} height={30} />
//             </TouchableOpacity>
//             <TouchableOpacity onPress={endCallHandler}>
//               <SvgXml xml={SVG_hangout_red} width={80} height={80} />
//             </TouchableOpacity>
//           </View>
//           <View style={styles.infoContainer}>
...
//     return unsubscribe;
//   }, [navigation, activeCall, isMinimized, minimizeCall]);
